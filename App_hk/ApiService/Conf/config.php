...
return array(
    ...
    'URL_ROUTE_RULES'      => array(
        ...
        'api/m/lessons/:classId/free'       =>  'index/lessons_free',//4.班级下免费课程资(视频)源集合[用于免费体验]
        'api/m/categories'                  =>  'index/categories',//5.考试类别集合(含有考试的考试类别)[用于免费体验]
        'api/m/exams/:categoryId'           =>  'index/exams',//6.考试类别下考试下集合[用于免费体验]
        'api/m/packages/:agencyId/:examId'  =>  'index/packages',//7.机构考试下套餐/班级集合[用于免费体验]
        'api/m/learning'                    =>  'index/learning',//8.上传学习记录(POST)
        'api/m/aq/topic/:agencyId/:userId'  =>  'index/load_topics',//9.获取答疑主题数据
